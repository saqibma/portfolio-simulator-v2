...
@pytest.mark.parametrize(
    "child_portfolios, expected_result",
    [
        ({"AAPL": Asset("AAPL", price=0)}, False),
        ({"AAPL": Asset("AAPL", price=150)}, True),
        ({"AAPL": Asset("AAPL", price=150), "GOOGL": Asset("GOOGL", price=250)}, True),
        ({"AAPL": Asset("AAPL", price=150), "GOOGL": Asset("GOOGL", price=0)}, False),
    ],
)
